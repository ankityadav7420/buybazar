...
from app.core.security import require_admin, require_self_or_admin, require_user
...
async def get_orders_by_user_id(
    ...
    if current_user["id"] != user_id:
        raise HTTPException(status_code=403, detail="Cannot fetch another user's orders")
...
async def get_order_by_id(
    ...
    return await order_controller.get_order_by_id(db, order_id)
